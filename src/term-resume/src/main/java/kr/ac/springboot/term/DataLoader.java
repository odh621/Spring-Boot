...
public class DataLoader implements ApplicationRunner {
	...
	Resume r = new Resume(2014958100, "Donghun Lim", "SCIENCE OF SOFTWARE, UNIVERSITY OF KYUNGSUNG", "ODH621@LIKELION.ORG", "뛰어난 개발자가 되기 위해 노력하며 항상 새로운 벽에 부딪히고 있는 소프트웨어학과 학생 개발자 임동훈입니다.");
